    ...
    <div className="category-navigation">
      <Container>
        <div className="category-grid">
          <Col style={{ padding: 0 }}>
            <Link to="/books/category/biography"> <h2 className="text-block"> Biography </h2>
          ...
          <Col style={{ padding: 0 }}>
            <Link to="/books/category/business"> <h2 className="text-block"> Business </h2>
          ...
          <Col style={{ padding: 0 }}>
            <Link to="/books/category/fiction"> <h2 className="text-block"> Fiction </h2>
          ...
          <Col style={{ padding: 0 }}>
            <Link to="/books/category/mystery"> <h2 className="text-block"> Mystery </h2>
          ...
          <Col style={{ padding: 0 }}>
            <Link to="/books/category/nonfiction"> <h2 className="text-block"> Non-fiction </h2>
